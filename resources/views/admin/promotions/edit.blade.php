...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('admin.coffee-shops.promotions.update', [$coffeeShop, $promotion]) }}" method="POST" class="bg-white rounded-lg shadow p-6">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 mt-6 border-t">
                ...
                <button type="submit" class="px-6 py-2 bg-coffee-600 text-white rounded-lg font-semibold hover:bg-coffee-700 transition">Update</button>
            </div>
        </form>
    </div>
</div>
